            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: NetworkImage(globals.imageUrl + property.image1),
                  fit: BoxFit.cover,
                ),
              ),
              child: Container(
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                    image: NetworkImage(
                                        globals.imageUrl + property.image1),
                                    fit: BoxFit.cover,
                                  ),
                                  shape: BoxShape.circle,
                                ),
                            ...
                            children: [
                              Container(
                                ...
                                child: Center(
                                  child: Icon(
                                    Icons.phone,
                                    color: Color.fromARGB(255, 27, 0, 145),
                                    size: 20,
                                  ),
                                ),
                              ),
                              ...
                              Container(
                                ...
                                child: Center(
                                  child: Icon(
                                    Icons.message,
                                    color: Color.fromARGB(255, 19, 0, 141),
                                    size: 20,
                                  ),
                                ),
                              ),
    ...
    return AspectRatio(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          image: DecorationImage(
            image: NetworkImage(globals.imageUrl + url),
            fit: BoxFit.cover,
          ),
        ),
      ),
